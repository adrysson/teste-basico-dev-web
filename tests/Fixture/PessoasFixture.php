...
class PessoasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'celular' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'celular' => ['type' => 'unique', 'columns' => ['celular'], 'length' => []],
            'pessoas_ibfk_1' => ['type' => 'foreign', 'columns' => ['cidade_id'], 'references' => ['cidade', 'id_cidade'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
